...
class resnet(nn.Module):
    def __init__(self, res_name='resnet50', bottleneck_dim=256):
        ...
        self.backbone = nn.Sequential(*list(model_resnet.children())[:-1])                  # feature_layers
        self.feat_bottleneck = feat_bottleneck(self.in_features_dim, self.bottleneck_dim )  # bottle + bn
